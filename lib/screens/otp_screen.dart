...
class _OTPScreenState extends State<OTPScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(
      child: Scaffold(
        appBar:
            ApplicationToolbar(appbarTitle: Languages.of(context)!.labelOTP),
  ...
  Future<BaseModel<CheckOTPForForgotPasswordModel>> callForgotPasswordVerifyOTP(
      String enteredOTP) async {
    ...
    try {
      ...
      response = await RestClient(RetroApi().dioData())
          .checkOtpForForgotPassword(body);
      Constants.hideDialog(context);
      print(response.success);
      if (response.success!) {
        Constants.toastMessage(response.msg!);
