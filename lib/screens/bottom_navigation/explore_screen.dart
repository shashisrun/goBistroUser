...
class _ExploreScreenState extends State<ExploreScreen> {
  ...
  Future<BaseModel<ExploreRestaurantListModel>> callGetFilteredDataList(
      String selectedCuisineId, String? sortBy, String? quick) async {
    ExploreRestaurantListModel response;
    try {
      _exploreResListData.clear();
                    ...
                    appBar: ApplicationToolbarWithClrBtn(
                      ...
                      onBtnPress: () {
                        ...
                        Constants.checkNetwork()
                            .whenComplete(() => callExploreRestaurants());
                        setState(() {});
                      },
                    ),
