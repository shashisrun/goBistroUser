...
class _HomeScreenState extends State<HomeScreen> {
  ...
  getOneSingleToken(String appId) async {
    ...
    userId != null
        ...
        : SharedPreferenceUtil.putString(Constants.appPushOneSingleToken, "");
  ...
  getUserLocation() async {
    int selectedAdd = SharedPreferenceUtil.getInt(Constants.selectedAddressId);
    if (selectedAdd == 0) {
      ...
      SharedPreferenceUtil.putString(
          'selectedLat', _center.latitude.toString());
      SharedPreferenceUtil.putString(
          'selectedLng', _center.longitude.toString());
  ...
  void initState() {
    ...
    SharedPreferenceUtil.putInt(Constants.currentTable, 0);
                        ...
                        Visibility(
                          ...
                          child: Container(
                            ...
                            decoration: new BoxDecoration(
                                color: Constants.colorLikeLight),
                            child: ListTile(
