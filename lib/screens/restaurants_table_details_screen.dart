...
class RestaurantsTableDetailsScreen extends StatefulWidget {
  final int? restaurantId;
  final int? tableId;
  final bool? isFav;

  const RestaurantsTableDetailsScreen(
      {Key? key, required this.restaurantId, required this.tableId, this.isFav})
      : super(key: key);

  @override
  _RestaurantsTableDetailsScreenState createState() =>
      _RestaurantsTableDetailsScreenState();
}

class _RestaurantsTableDetailsScreenState
    extends State<RestaurantsTableDetailsScreen> {
