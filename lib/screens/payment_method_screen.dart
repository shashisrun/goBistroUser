                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: RoundedCornerAppButton(
                                    ...
                                    MaterialPageRoute(
                                      builder: (BuildContext context) =>
                                        ...
                                        onFinish: (number) async {
                                          ...
                                          if (number != null &&
                                              number.toString() != '') {
                                            strPaymentToken = number.toString();
                                            placeOrder();
                                          }
                                        },
                                      ),
                          ...
                          btnLabel: Languages.of(context)!.labelPlaceYourOrder,
                        ),
                      ),
                    ],
                  )),
  ...
  Future<BaseModel<CommenRes>> placeOrder() async {
    ...
    try {
      ...
      Map<String, String?> body = {
        ...
        'order_request': widget.orderRequest,
        'table_id': SharedPreferenceUtil.getInt(Constants.currentTable) > 0
            ? SharedPreferenceUtil.getInt(Constants.currentTable).toString()
            : null
      };
