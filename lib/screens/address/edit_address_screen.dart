...
class _EditAddressScreenState extends State<EditAddressScreen> {
                                ...
                                child: Padding(
                                  ...
                                  child: Row(children: [
                                    GestureDetector(
                                      onTap: () {
                                        setState(() {
                                          _textAddressLable.text = "HOME";
                                          print(_textAddressLable.text);
                                        });
                                      },
                                      child: Container(
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                Padding(
                                  ...
                                  child: GestureDetector(
                                    onTap: () {
                                      if (_textFullAddress.text == '') {
                                        Constants.toastMessage(
                                            Languages.of(context)!
                                                .labelPleaseSearchAddress);
                                      } else if (_textAddressLable
                                          .text.isEmpty) {
                                        Constants.toastMessage(
                                            Languages.of(context)!
  ...
  Future<BaseModel<UpdateAddressModel>> callUpdateUserAddress(
      int? addressId) async {
    ...
    try {
      ...
      response =
          await RestClient(RetroApi().dioData()).updateAddress(addressId, body);
