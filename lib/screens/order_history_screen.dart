                                      ...
                                      onTap: () {
                                        ...
                                        Navigator.of(context).push(Transitions(
                                            ...
                                            widget: OrderDetailsScreen(
                                              ...
                                              orderDate:
                                                  _listOrderHistory[index].date,
                                              orderTime:
                                                  _listOrderHistory[index].time,
                                            )));
                                      },
                                      child: Card(
                                                                      ...
                                                                      child: Text(
                                                                          (() {
                                                                            String
                                                                                qty =
                                                                                '';
                                                                            if (_listOrderHistory[index].orderItems!.length > 0 &&
                                                                                _listOrderHistory[index].orderItems != null) {
                                                                    ...
                                                                    children: [
                                                                      ...
                                                                      TextSpan(
                                                                        text:
                                                                          ...
                                                                          // your code here
                                                                          // _listOrderHistory[index].orderStatus == 'PENDING' ? 'Ordered on ${_listOrderHistory[index].date}, ${_listOrderHistory[index].time}' : 'Delivered on October 10,2020, 09:23pm',
                                                                          if (_listOrderHistory[index].orderStatus == 'CANCEL' ||
                                                                              _listOrderHistory[index].orderStatus == 'COMPLETE') {
                                                                  ...
                                                                  if (_currentLatitude !=
                                                                    ...
                                                                    Navigator.of(context).push(Transitions(
                                                                        ...
                                                                        widget: TrackYourOrderScreen(
                                                                          vendorName: _listOrderHistory[index]
                                                                              .deliveryPerson!
                                                                              .name,
                                                                          vendorNumber: _listOrderHistory[index]
                                                                              .deliveryPerson!
                                                                              .contact,
                                                                          vendorImage: _listOrderHistory[index]
                                                                              .deliveryPerson!
                                                                              .image,
                                                                          orderId:
                                                                              _listOrderHistory[index].id,
                                                                          ...
                                                                          orderDate:
                                                                              _listOrderHistory[index].date,
                                                                          shopLat: double.parse(_listOrderHistory[index]
                                                                              .vendor!
                                                                              .lat
                                                                              .toString()),
                                                                          shopLong: double.parse(_listOrderHistory[index]
                                                                              .vendor!
                                                                              .lang
                                                                              .toString()),
                                                                          currentLat:
