...
class Constants {
  /*map key*/
  static final String androidKey = 'AIzaSyBnX7fS4iqbowpkkiJal8mIG0YVO';
  static final String iosKey = 'AIzaSyBnX7fS4iqbowpkkiJal8mIG0YVO';
  ...
  static Color colorTheme = Color.fromARGB(255, 255, 145, 0);
...
/*  static String loginLanguage = 'loginLanguage';
  ...
  static String currentTable = 'current_table';
